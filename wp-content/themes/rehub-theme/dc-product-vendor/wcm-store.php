			...
			<div class="rh-cartbox widget">
				<div>
					...
					<div class="profile-stats">
						<div><i class="rhicon rhi-user-circle"></i> <?php esc_html_e( 'Registration', 'rehub-theme' );  echo ': ' . date_i18n( get_option( "date_format" ), strtotime( $vendor->user_data->user_registered )); ?></div>
