			...
			<div class="pl20 pr20 tabledisplay <?php echo ''.$adaptive_class; ?>">
	    		...
	    		<div id="wcvendor_profile_act_desc" class="wcvendor_profile_cell">
	    			<div class="wcvendor_store_name">
						<?php if ( $verified_vendor ) : ?>	   			
							<div class="wcv-verified-vendor">
								<i class="rhicon rhi-shield-check" aria-hidden="true"></i>
							</div>
						<?php endif; ?>	    			
					...
					<div class="wcmvendor_store_phones font80 lineheight15">
						<?php if ($vendor_phone) : ?>
							<i class="rhicon rhi-mobile-android-alt"></i> <?php echo esc_html($vendor_phone); ?><br />
						<?php endif; ?>
						<?php if ($vendor_email ) : ?>
							<i class="rhicon rhi-envelope"></i> <?php echo esc_html($vendor_email); ?><br />
						<?php endif; ?>
						<?php if ($external_store_url ) : ?>
							<i class="rhicon rhi-globe"></i> <?php echo esc_url($external_store_url); ?>
						<?php endif; ?>
					</div>
	    		</div>
	    		<div id="wcvendor_profile_act_btns" class="wcvendor_profile_cell">
					...
					<div class="profile-socbutton">
						<div class="social_icon small_i">
							<?php if ( $vendor_fb_profile != '') { ?><a href="<?php echo esc_url($vendor_fb_profile); ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="rhicon rhi-facebook"></i></a><?php } ?>
							<?php if ( $vendor_instagram != '') { ?><a href="//instagram.com/<?php echo esc_attr($vendor_instagram); ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="rhicon rhi-instagram"></i></a><?php } ?>
							<?php if ( $vendor_twitter_profile != '') { ?><a href="//twitter.com/<?php echo esc_attr($vendor_twitter_profile); ?>" target="_blank" class="author-social tw" rel="nofollow"><i class="rhicon rhi-twitter"></i></a><?php } ?>
							<?php if ( $vendor_google_plus_profile != '') { ?><a href="<?php echo esc_url($vendor_google_plus_profile); ?>" target="_blank" class="author-social gp" rel="nofollow"><i class="rhicon rhi-google-plus"></i></a><?php } ?>
							<?php if ( $vendor_youtube != '') { ?><a href="<?php echo esc_url($vendor_youtube); ?>" target="_blank" class="author-social yt" rel="nofollow"><i class="rhicon rhi-youtube"></i></a><?php } ?>
							<?php if ( $vendor_linkdin_profile != '') { ?><a href="<?php echo esc_url($vendor_linkdin_profile); ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="rhicon rhi-linkedin"></i></a><?php } ?>
						 </div>
					</div>
					<?php endif; ?>
