...
<?php if(rehub_option('rehub_body_font')) : ?>
	.woocommerce ul.product_list_widget li a, .widget.better_woocat,.tabs-menu li, .cats_def a, .widget.tabs > ul > li,.related_articles ul li > a, .sidebar, .prosconswidget, .rehub-body-font, body {
