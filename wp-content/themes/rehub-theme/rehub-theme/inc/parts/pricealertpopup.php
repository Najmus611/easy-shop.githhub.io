...
<?php if(defined('\ContentEgg\PLUGIN_PATH')):?>
    <?php if (ContentEgg\application\helpers\TemplateHelper::isPriceAlertAllowed($unique_id, $module_id)): ?>
        ...
        <div class="pricealertpopup-wrap flowhidden">
            <span class="csspopuptrigger floatright mb10 greencolor" data-popup="pricealert_<?php echo ''.$rand;?>"><i class="rhicon rhi-bell mr5" aria-hidden="true"></i> <?php esc_html_e('Set Lowest Price Alert', 'rehub-theme');?></span>
