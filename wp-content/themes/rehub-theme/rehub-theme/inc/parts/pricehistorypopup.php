...
<?php if(defined('\ContentEgg\PLUGIN_PATH')):?>
    ...
    <?php if($pricescheck):?>
        ...
        <span class="csspopuptrigger floatright" data-popup="pricehistory_<?php echo ''.$rand;?>"><i class="rhicon rhi-chart-bar" aria-hidden="true"></i> <?php esc_html_e('Price history', 'rehub-theme');?></span>
