	...
	<div class="rehub-demo-themes rehub-install-plugins">
		...
		<div class="feature-section theme-browser rendered">
			...
			<div class="theme">
				...
				<div class="theme-actions">
					<?php if( $registeredlicense == true ) :?>						
						<a href="<?php echo PLUGIN_REPO;?>packages/importwp-pro.zip" class="button button-primary" title="Get link">Download</a>
					<?php else :?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', admin_url( 'admin.php?page=rehub' ), esc_html__("Register theme to get link", "rehub-theme" ) ); ?>
					<?php endif;?>		
				</div>
			...
			<div class="theme">
				...
				<div class="theme-actions">
					<?php if( $registeredlicense == true ) :?>						
						<a href="<?php echo PLUGIN_REPO;?>packages/importwp-rhaddon.zip" class="button button-primary" title="Get link">Download</a>
					<?php else :?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', admin_url( 'admin.php?page=rehub' ), esc_html__("Register theme to get link", "rehub-theme" ) ); ?>
					<?php endif;?>		
				</div>
			...
			<div class="theme">
				...
				<div class="theme-actions">
					<?php if( $registeredlicense == true ) :?>						
						<a href="<?php echo PLUGIN_REPO;?>packages/importwp-woocommerce.zip" class="button button-primary" title="Get link">Download</a>
					<?php else :?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', admin_url( 'admin.php?page=rehub' ), esc_html__("Register theme to get link", "rehub-theme" ) ); ?>
					<?php endif;?>		
				</div>
