 ...
 */
 ...
 jQuery(document).ready(function($) {
	...
	ShowHideFunc(
	   $('#_customize-input-rehub_logo_inmenu-radio-0'),
	   $('#_customize-input-rehub_logo_inmenu-radio-1'),
	   $('#customize-control-rehub_logo_inmenu_url')
	);
	...
	var menuconditionals = {
		...
		"header_five" : ["header_seven_more_element", "header_six_src", "header_six_btn_login", "header_six_btn_url", "header_six_btn_txt", "header_six_btn_color", "header_six_btn", "header_six_login", "header_seven_cart_as_btn", "header_seven_cart", "header_five_menucenter", "header_src_icon", "header_six_menu"],
	};
