...
final class REHub_Framework_Customizer {
	...
	public function rh_customize_register( $wp_customize ) {
		...
		*/
		...
		$wp_customize->add_setting( 'rehub_logo_inmenu', array(
			'sanitize_callback' => 'sanitize_key',
			'default' => '0',
		));
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'rehub_logo_inmenu', array(
			'label' => esc_html__('Enable compact logo of header on mobiles', 'rehub-framework'),
			'section'  => 'title_tagline',
			'settings' => 'rehub_logo_inmenu',
			'type' => 'radio',
			'choices' => array(
				'0'  => esc_html__('Off', 'rehub-framework'),
				'1' => esc_html__('On', 'rehub-framework'),
