...
<div class="commercekit-inventory">
	<span class="title"><?php echo esc_html( sprintf( $final_display_text, $commercekit_stock_quantity ) ); ?></span>
	...
	if ( $product->is_type( 'variable' ) && count( $stock_quantities ) ) {
		...
		foreach ( $stock_quantities as $stock_key => $stock_value ) {
			...
			<?php } ?>
			<span class="title"><?php echo esc_html( sprintf( $final_display_text, $stock_value ) ); ?></span>
			<div class="progress-bar full-bar <?php echo 'default' === $stock_key ? 'active' : ''; ?>"><span></span></div>
		</div>
			<?php
		}
		?>
