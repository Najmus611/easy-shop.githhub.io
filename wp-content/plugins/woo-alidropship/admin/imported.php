        ...
        <div class="<?php echo esc_attr( self::set( array(
            ...
            <div class="<?php echo esc_attr( self::set( 'delete-product-options-content' ) ) ?>">
                ...
                <div class="<?php echo esc_attr( self::set( 'delete-product-options-content-footer' ) ) ?>">
                    <span class="vi-ui button positive tiny <?php echo esc_attr( self::set( array(
                    ...
                    <span class="vi-ui button tiny negative <?php echo esc_attr( self::set( array(
                    ...
                    <span class="vi-ui button tiny <?php echo esc_attr( self::set( 'delete-product-options-button-cancel' ) ) ?>">
                        ...
                        <div class="title <?php esc_attr_e( $accordion_active ) ?>">
                            ...
                            <div class="<?php echo esc_attr( self::set( 'accordion-product-image-title-container' ) ) ?>">
                                ...
                                <div class="<?php echo esc_attr( self::set( 'button-view-and-edit' ) ) ?>">
									...
									?>
                                    <span class="vi-ui button negative tiny loading <?php echo esc_attr( self::set( 'button-deleting' ) ) ?>"><?php esc_html_e( 'Delete', 'woo-alidropship' ) ?></span>
                                </div>
                            </div>
                        </div>
