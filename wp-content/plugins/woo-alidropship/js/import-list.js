...
jQuery(document).ready(function ($) {
        ...
        if (change > 0) {
            ...
            $.ajax({
                ...
                complete: function () {
                    $button.removeClass('loading');
                    $overlay.addClass('vi-wad-hidden');
                    $row.find('.vi-wad-attributes-button-edit').removeClass('vi-wad-hidden');
                    $row.find('.vi-wad-attributes-button-save-cancel').addClass('vi-wad-hidden');
    ...
    $(document).on('click', '.vi-wad-attributes-button-edit', function () {
        ...
        $column.find('.vi-wad-attributes-button-save-cancel').removeClass('vi-wad-hidden');
