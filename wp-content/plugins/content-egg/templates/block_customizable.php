    ...
    <?php foreach ($items as $item): ?>
        ...
        switch ($params['show'])
        {
            ...
            case 'currencycode':
                ...
                break;
            case 'button':
                echo '<span class="egg-container"><a' . TemplateHelper::printRel(false) . ' target="_blank" href="' . $item['url'] . '" class="btn btn-success">' . TemplateHelper::buyNowBtnText(false, $item) . '</a></span>';
                break;
            case 'stock_status':
