            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="cegg-btn-row cegg-mb20">
                        <a<?php TemplateHelper::printRel();?> target="_blank" href="<?php echo $item['url']; ?>" class="btn btn-success cegg-btn-big"><?php $time_left ? TemplateHelper::buyNowBtnText(true, $item) : _e('VIEW THIS ITEM', 'content-egg-tpl'); ?></a>
