            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="cegg-btn-row cegg-mb20">
                        <a<?php TemplateHelper::printRel();?> target="_blank" href="<?php echo $item['url']; ?>" class="btn btn-success cegg-btn-big cegg-mb5"><?php TemplateHelper::buyNowBtnText(true, $item); ?></a>
                        <br/>
